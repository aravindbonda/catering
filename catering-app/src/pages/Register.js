...
function Register() {
  ...
  return (
    <section className="grid min-h-[75vh] place-items-center px-4 py-12">
      <form className="panel-card w-full max-w-2xl rounded-[1.5rem] p-6 md:p-8" onSubmit={submit}>
        <p className="eyebrow">Customer Registration</p>
        <h1 className="mt-2 text-3xl font-extrabold text-stone-950 md:text-4xl">Create your catering account</h1>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          <label>
            <span className="mb-1 block text-sm font-bold text-stone-700">Full Name</span>
            <input className="input-field" name="fullName" placeholder="Enter full name" value={form.fullName} onChange={update} required />
          </label>
          <label>
            <span className="mb-1 block text-sm font-bold text-stone-700">Email Address</span>
          ...
          <label>
            <span className="mb-1 block text-sm font-bold text-stone-700">Confirm Password</span>
          ...
          <label>
            <span className="mb-1 block text-sm font-bold text-stone-700">Primary Event Location</span>
          ...
          <label>
            <span className="mb-1 block text-sm font-bold text-stone-700">Preferred City</span>
          ...
          <label className="md:col-span-2">
            <span className="mb-1 block text-sm font-bold text-stone-700">User Type</span>
